...
```
    ...
    <networkx.classes.graph.Graph at 0x7f6f1e63abe0>
...
```
    ...
    [('Eddard-Stark', 0.04552079222830671),
     ('Tyrion-Lannister', 0.03301362462493269),
     ('Catelyn-Stark', 0.030193105286631914),
     ('Robert-Baratheon', 0.02983474222773675),
     ('Jon-Snow', 0.02683449952206619),
     ('Robb-Stark', 0.021562941297247524),
     ('Sansa-Stark', 0.020008034042864654),
     ('Bran-Stark', 0.019945786786238318),
     ('Jaime-Lannister', 0.017507847202846937),
...
```
    ...
    [('Eddard-Stark', 0.0723940110049824),
     ('Robert-Baratheon', 0.0485172757050994),
     ('Jon-Snow', 0.04770689062474911),
     ('Tyrion-Lannister', 0.04367437892706296),
     ('Catelyn-Stark', 0.034667034701307414),
     ('Bran-Stark', 0.029774200539800212),
     ('Robb-Stark', 0.02921618364519686),
     ('Daenerys-Targaryen', 0.027089622513021085),
...
![png](images/05-casestudies_01-gameofthrones_md_52_1.png)
